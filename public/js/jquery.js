...
var viewControl = (function () {
    ...
    var createButton = (page, type) =>//next or prev
        `<a href="#home" class="btn__forth" data-goto="${type === "next" ? page + 1 : page - 1}">
    ...
    return {
        ...
        displayProjects: function (list, page) {
            ...
            list.forEach((ele) => {
                let HtmlElement = `<div class="grid__cell grid__cell--1 ">
                 <img src="${ele.imgHref}" alt="project1" class="projects__img ">
                     <div class="caption1">
                         <a class="btn__tertiary margin-bottom-u-b">
                             see it
                         </a>
                ...
                document.querySelector(this.DOMStrings.gridLab).insertAdjacentHTML('beforeEnd', HtmlElement);
            });
        },
        displayCertificates: function (list, page) {
            ...
            list.forEach((ele, ind) => {
                ...
                document.querySelector(this.DOMStrings.box).insertAdjacentHTML('beforeEnd', HtmlElement);
            });
        }
    }
})();
...
var modelControl = (function () {
    ...
    var Project = function (name, type, tools, descrption, imgHref) {
        this.name = name;
        this.type = type;
        this.tools = tools;
    ...
    let cert = new Certificate('ICDL', 'studying', `Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error asperiores consectetur ratione, reprehenderit perspiciatis
    ...
    quae!`, './img/certif--1.png');
    certificates.types.studying.push(cert);
    cert = new Certificate('DBMS', 'studying', `Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error asperiores consectetur ratione, reprehenderit perspiciatis
    quidem quod. Soluta, suscipit? Eos minima ea minus officia. Excepturi a quod voluptates!
    Esse, mollitia nisi? Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis,
    quae!`, './img/certif--3.png"');
    certificates.types.studying.push(cert);
    cert = new Certificate('design', 'studying', `Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error asperiores consectetur ratione, reprehenderit perspiciatis
    quidem quod. Soluta, suscipit? Eos minima ea minus officia. Excepturi a quod voluptates!
    Esse, mollitia nisi? Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis,
    quae!`, './img/certif--1.png');
    ...
    let pro = new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--1.png');
    projects.types.photoshop.push(pro);
    pro = new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--2.png');
    projects.types.photoshop.push(pro);
    pro = new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--3.png');
    projects.types.photoshop.push(pro);
    new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--1.png');
    projects.types.photoshop.push(pro);
    pro = new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--2.png');
    projects.types.photoshop.push(pro);
    pro = new Project('photoshop', 'photoshop', 'html css sass', 'abdulfattah', './img/projetcs__img--3.png');
    ...
    pro = new Project('templates', 'templates', 'html css sass', 'abdulfattah', './img/projetcs__img--4.png');
    projects.types.template.push(pro);
    pro = new Project('templates', 'templates', 'html css sass', 'abdulfattah', './img/projetcs__img--5.png');
    projects.types.template.push(pro);
    pro = new Project('templates', 'templates', 'html css sass', 'abdulfattah', './img/projetcs__img--6.png');
    projects.types.template.push(pro);

    pro = new Project('meanStack', 'meanStack', 'html css sass', 'abdulfattah', './img/projetcs__img--1.png');
    projects.types.meanStack.push(pro);
    pro = new Project('meanStack', 'meanStack', 'html css sass', 'abdulfattah', './img/projetcs__img--2.png');
    projects.types.meanStack.push(pro);
    pro = new Project('meanStack', 'meanStack', 'html css sass', 'abdulfattah', './img/projetcs__img--3.png');
    projects.types.meanStack.push(pro);
    ...
    return {
        ...
        addProjects: function () {
            ...
            const tool = prompt("enter the tools that you used to make this project: ");
...
var Controller = (function (UICtrl, MCtrl) {
    ...
    var eventListener = function () {
        document.querySelector(DOMSrings.navBarItem).addEventListener('click', e => {
            e.preventDefault();
            if (e) {
                UICtrl.findType(e);
                page1 = 1;
        ...
        document.querySelector(DOMSrings.navBarItemCertificates).addEventListener('click', e => {
            e.preventDefault();
            if (e) {
                UICtrl.findType(e);
                page2 = 1;
        ...
        document.querySelector('.certificates .buttons').addEventListener('click', e => {
            console.log(e);
            e.preventDefault();
    ...
    var changeTheContent = function () {
        ...
        if (type === "All")
            list = MCtrl.getAllProjects();
        else
            list = MCtrl.getProjectsList(type);
        UICtrl.clearScreen();
    ...
    var changeCertificates = function () {
        ...
        if (type === "All")
            list = MCtrl.getAllCertificates();
        else
            list = MCtrl.getCertificateList(type);
